...
operEquity = 15  # defines the target amount per execution ($)
limitOrderMargin = 0.1  # percentage that defines the offset for the limit orders

# YOUR API KEYS AT ALPACA GO HERE!
API_KEY = "PKT2VLYQ6SP41LN7SHCK"
API_SECRET_KEY = "GP2qSNOOa4jCyrNJAQDsUXK35oDgSuh01mNk163u"
...
fetchItval = {"little": "5Min", "big": "30Min"}

# timeouts that will kill a process
timeouts = {"GT": 0}  # if 0, it discards a bad general trend instantly
...
RAW_ASSETS = (
    "./_raw_assets.csv"  # you should have this list at the same folder than everything
)
